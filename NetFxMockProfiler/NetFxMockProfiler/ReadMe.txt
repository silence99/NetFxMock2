========================================================================
    ACTIVE TEMPLATE LIBRARY : NetFxMockProfiler Project Overview
========================================================================

AppWizard has created this NetFxMockProfiler project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

NetFxMockProfiler.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

NetFxMockProfiler.vcxproj.filters
...
NetFxMockProfiler.idl
    This file contains the IDL definitions of the type library, the interfaces
    and co-classes defined in your project.
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (NetFxMockProfiler.h)
        GUID definitions                                (NetFxMockProfiler_i.c)
        A type library                                  (NetFxMockProfiler.tlb)
        Marshaling code                                 (NetFxMockProfiler_p.c and dlldata.c)

NetFxMockProfiler.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in NetFxMockProfiler.idl. It will be regenerated by MIDL during compilation.

NetFxMockProfiler.cpp
    This file contains the object map and the implementation of your DLL's exports.

NetFxMockProfiler.rc
    This is a listing of all of the Microsoft Windows resources that the
    program uses.

NetFxMockProfiler.def
...
StdAfx.h, StdAfx.cpp
    ...
    named NetFxMockProfiler.pch and a precompiled types file named StdAfx.obj.
...
NetFxMockProfilerps.vcxproj
	...
	dlldata.c, NetFxMockProfiler_i.c and NetFxMockProfiler_p.c which are required
	to build the proxy/stub DLL.

NetFxMockProfilerps.vcxproj.filters
